...
int main() {
    ...
    button1.setFillColor(sf::Color(255, 200, 200)); button1.setPosition(10, 10);
    sf::RectangleShape button2(sf::Vector2f(50, 30));
    button2.setFillColor(sf::Color(200, 255, 200)); button2.setPosition(70, 10);
    sf::RectangleShape button3(sf::Vector2f(50, 30));
    button3.setFillColor(sf::Color(200, 220, 255)); button3.setPosition(130, 10);
    sf::RectangleShape button4(sf::Vector2f(50, 30));
    button4.setFillColor(sf::Color(255, 255, 200)); button4.setPosition(190, 10);
    sf::RectangleShape squaresButton(sf::Vector2f(70, 30));
    squaresButton.setFillColor(sf::Color(180, 180, 255)); squaresButton.setPosition(250, 10);
    sf::RectangleShape drawButton(sf::Vector2f(70, 30));
    drawButton.setFillColor(sf::Color(180, 255, 180)); drawButton.setPosition(330, 10);
    sf::RectangleShape circleButton(sf::Vector2f(70, 30));
    circleButton.setFillColor(sf::Color(255, 180, 180)); circleButton.setPosition(410, 10);
        ...
        while (window.pollEvent(event)) {
            if (event.type == sf::Event::Closed) window.close();
                ...
                if (event.mouseButton.button == sf::Mouse::Left) {
                    ...
                    if (button1.getGlobalBounds().contains(mousePos.x, mousePos.y)) backgroundColor = sf::Color(255, 200, 200);
                    else if (button2.getGlobalBounds().contains(mousePos.x, mousePos.y)) backgroundColor = sf::Color(200, 255, 200);
                    else if (button3.getGlobalBounds().contains(mousePos.x, mousePos.y)) backgroundColor = sf::Color(200, 220, 255);
                    else if (button4.getGlobalBounds().contains(mousePos.x, mousePos.y)) backgroundColor = sf::Color(255, 255, 200);
                    else if (squaresButton.getGlobalBounds().contains(mousePos.x, mousePos.y)) currentMode = DrawingMode::Rectangle;
                    else if (drawButton.getGlobalBounds().contains(mousePos.x, mousePos.y)) currentMode = DrawingMode::FreeDraw;
                    else if (circleButton.getGlobalBounds().contains(mousePos.x, mousePos.y)) currentMode = DrawingMode::Circle;
